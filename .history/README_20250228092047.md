...
<div style="display: flex; justify-content: space-between; gap: 20px;">
  ...
  <div style="flex: 1; padding: 20px; border: 2px solid #ddd; border-radius: 10px;; box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.1); background:"background: #f9f9f9;">
  ...
  <div style="flex: 1; padding: 20px; border: 2px solid #ddd; border-radius: 10px;  box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.1);">
